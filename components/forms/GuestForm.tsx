          ...
          {currentStep === 'email' ? (
            ...
            >
              ...
              <motion.div
                ...
                className="bg-gradient-to-r from-amber-500/10 to-amber-600/10 rounded-lg p-4 border border-amber-500/20"
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-2 text-xs text-gray-300">
                      <div>✅ Choose dining preferences</div>
                      <div>🍷 Select welcome drink</div>
